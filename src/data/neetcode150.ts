import type { ListItem } from './blind75'

// The NeetCode 150 interview list (slugs). Titles are prettified from the slug
// for the "remaining" checklist. Matching against solved problems is by slug.
const SLUGS: string[] = [
  // Arrays & Hashing
...
const SPECIAL: Record<string, string> = {
  ...
  'number-of-connected-components-in-an-undirected-graph': 'Connected Components in Undirected Graph',
  'n-queens': 'N-Queens',
}
...
export const NEETCODE150: ListItem[] = SLUGS.map((slug) => ({ slug, title: pretty(slug) }))
