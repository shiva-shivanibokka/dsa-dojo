// The NeetCode 250 as a curated "still to do" roadmap: every problem carries its
...
export const NC250_PATTERNS: string[] = [
  'Arrays & Hashing',
  'Two Pointers',
  'Sliding Window',
  'Stack',
...
const P = (pattern: string, items: [string, string, Diff][]): RoadmapProblem[] =>
  items.map(([slug, title, difficulty]) => ({ slug, title, difficulty, pattern }))

export const NEETCODE250: RoadmapProblem[] = [
  ...P('Arrays & Hashing', [
